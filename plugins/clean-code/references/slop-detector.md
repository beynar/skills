...
Use this skill when the user asks to: detect slop, scan for AI patterns, check for over-engineering, find unnecessary code, audit AI output, or do a quick quality check.
