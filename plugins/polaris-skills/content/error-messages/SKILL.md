---
name: polaris-content-error-messages
description: Write error messages that fix problems instead of frustrating users. Learn to explain what went wrong, how to fix it, and prevent future errors. Critical for form validation, alerts, and system messaging.
---
...
Follow fundamentals: keep it short, use plain language, get rid of repetition.

## Design for Clarity

- Use iconography and color to communicate severity and draw attention to what's wrong
- Place the error close to what needs fixed
- **Use red** for critical messages merchants need to deal with immediately to avoid harm to their business (form validation errors)
...
### Body
- If you don't have a header, clearly state the effect of the error
